...
import se.cygni.snake.client.api.model.MapEmpty;
import se.cygni.snake.client.api.model.MapFood;
import se.cygni.snake.client.api.model.MapObstacle;
import se.cygni.snake.client.api.model.MapSnakeBody;
import se.cygni.snake.client.api.model.MapSnakeHead;
import se.cygni.snake.client.api.model.SnakeDirection;
import se.cygni.snake.client.api.model.SnakeInfo;
import se.cygni.snake.client.api.model.TileContent;
...
public class MapUtil {
    ...
    private TileContent getSnakePart(int position) {
        ...
        int order = 0;
        for (int i = 0; i < snakeInfo.getPositions().length; i++) {
            if(position == snakeInfo.getPositions()[i]) {
                order = i;
            }
        }
